package com.example.rentacarv1.services.constants.model;

public class ModelMessages {
    public static final String MODEL_NOT_NULL = "The field cannot be null";
    public static final String ID_NOT_FOUND = "Model id was not found";
    public static final String MODEL_NOT_EXIST="This model is not exist ";
